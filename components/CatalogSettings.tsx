...
export default function CatalogSettingsProvider({
  ...
  // по роли ОДИН РАЗ при монтировании. При смене роли «на лету» в настройках
  // плотность не пересчитывается до перезагрузки — и это сделано намеренно:
  // персональный выбор плотности (ветка выше) и так главнее дефолта-по-роли,
  // а дефолт нужен только новичкам при самом первом открытии. Реактивный
