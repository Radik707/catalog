...
// Общий компонент модалки повтора (вынесен в этапе 20, план 02)
import ReorderSummaryModal from '@/components/ReorderSummaryModal';
// Утилиты склонения (вынесены в этапе 20, план 02)
import { pluralOrders, pluralItems } from '@/lib/plural';
...
// Модалка ReorderSummaryModal и функции склонения вынесены в общие модули:
// components/ReorderSummaryModal.tsx и lib/plural.ts (этап 20, план 02).
